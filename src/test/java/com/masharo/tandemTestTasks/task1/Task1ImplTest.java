...
class Task1ImplTest {
    ...
    String[] row2 = {"Hallo fel poll", "100", "fsdg iufdg u34 gr", "hallo fel poll", "hallo fel poll", null, ""};
    String[] row3 = {"kph kty", "0008", "jm hort5p4g 8", "kph kty", "fkd jfeljg oi", null, ""};
    String[] row4 = {"Kph kty", "0008", "jm hort5p4g 8", "kpa kty", "123", null, ""};
